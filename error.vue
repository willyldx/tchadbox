  ...
  <div class="min-h-screen bg-[var(--color-bg)] flex items-center justify-center p-4">
    <div class="text-center max-w-lg">
      ...
      <div class="relative mb-8">
        <div class="text-[120px] font-bold text-[var(--color-border)] leading-none select-none">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <button
          @click="handleError"
          class="px-8 py-4 bg-gray-900 border border-gray-900 text-white font-bold rounded-2xl hover:bg-gray-800 transition-all shadow-md mt-8"
        >
      ...
      <p class="text-sm text-[var(--color-text-muted)] mt-12">
        Besoin d'aide ? 
        <NuxtLink to="/contact" class="text-[var(--color-accent-dark)] hover:underline" @click="clearError()">
          Contactez-nous
        </NuxtLink>
      </p>
    </div>
