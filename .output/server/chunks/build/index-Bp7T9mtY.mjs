...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><div class="orb orb-amber w-96 h-96 -top-20 right-0 animate-float" style="${ssrRenderStyle({ "z-index": "2" })}" data-v-1bea5839></div><div class="container-main relative z-10 py-20" data-v-1bea5839><div class="max-w-2xl" data-v-1bea5839><div class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-8" data-v-1bea5839><span class="w-2 h-2 rounded-full bg-green-400 animate-pulse" data-v-1bea5839></span><span class="text-sm font-medium text-white/90" data-v-1bea5839>\u{1F1F9}\u{1F1E9} Service de livraison premium \xE0 N&#39;Djamena \u2014 Preuve photo garantie</span></div><div class="relative min-h-[180px] md:min-h-[160px]" data-v-1bea5839><!--[--><div data-v-1bea5839><h1 class="heading-hero text-white mb-6" data-v-1bea5839>${(_a = heroSlides[unref(currentSlide)].title) != null ? _a : ""}</h1><p class="text-xl text-white/80 mb-10 max-w-lg leading-relaxed" data-v-1bea5839>${ssrInterpolate(heroSlides[unref(currentSlide)].subtitle)}</p></div><!--]--></div><div class="flex flex-col sm:flex-row gap-4" data-v-1bea5839>`);
      ...
      _push(`<!--]--></div></div></section><section class="py-20 bg-[var(--color-bg-warm)]" data-v-1bea5839><div class="container-main" data-v-1bea5839><div class="text-center mb-14" data-v-1bea5839><span class="label mb-3 block" data-v-1bea5839>Nos gammes</span><h2 class="heading-section" data-v-1bea5839>Explorez nos <span class="text-gradient" data-v-1bea5839>cat\xE9gories</span></h2><p class="text-[var(--color-text-muted)] mt-3 max-w-lg mx-auto" data-v-1bea5839> Des produits rigoureusement s\xE9lectionn\xE9s, sourc\xE9s localement pour garantir fra\xEEcheur et qualit\xE9 </p></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" data-v-1bea5839><!--[-->`);
      ...
      if (unref(featuredProducts).length > 0) {
        _push(`<section class="py-20 bg-[var(--color-bg)]" data-v-1bea5839><div class="container-main" data-v-1bea5839><div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14" data-v-1bea5839><div data-v-1bea5839><span class="label mb-3 block" data-v-1bea5839>Les plus demand\xE9s</span><h2 class="heading-section" data-v-1bea5839>Nos <span class="text-gradient" data-v-1bea5839>best-sellers</span></h2></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/catalogue",
      ...
      _push(`<section class="py-24 bg-[var(--color-bg-warm)] relative overflow-hidden" data-v-1bea5839><div class="orb orb-amber w-80 h-80 -top-20 -right-20 opacity-10" data-v-1bea5839></div><div class="container-main relative" data-v-1bea5839><div class="text-center mb-16" data-v-1bea5839><span class="label mb-3 block" data-v-1bea5839>Simple et rapide</span><h2 class="heading-section" data-v-1bea5839>Comment \xE7a <span class="text-gradient" data-v-1bea5839>marche</span></h2><p class="text-[var(--color-text-muted)] mt-3 max-w-lg mx-auto" data-v-1bea5839> Un processus en 4 \xE9tapes pens\xE9 pour votre tranquillit\xE9 d&#39;esprit </p></div><div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative" data-v-1bea5839><div class="hidden md:block absolute top-14 left-[12.5%] right-[12.5%] h-px" data-v-1bea5839><div class="w-full h-full bg-gradient-to-r from-[var(--color-accent)]/20 via-[var(--color-accent)]/40 to-[var(--color-accent)]/20" data-v-1bea5839></div></div><!--[-->`);
      ...
      if (testimonials.length > 0) {
        _push(`<section class="py-24 bg-[var(--color-bg)]" data-v-1bea5839><div class="container-main" data-v-1bea5839><div class="text-center mb-14" data-v-1bea5839><span class="label mb-3 block" data-v-1bea5839>Ils nous font confiance</span><h2 class="heading-section" data-v-1bea5839>La parole \xE0 notre <span class="text-gradient" data-v-1bea5839>communaut\xE9</span></h2></div><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-1bea5839><!--[-->`);
      ...
      }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-1bea5839> Faites la diff\xE9rence <span class="text-gradient-gold" data-v-1bea5839>aujourd&#39;hui</span></h2><p class="text-xl text-white/70 mb-12 max-w-2xl mx-auto" data-v-1bea5839> Des milliers de familles re\xE7oivent d\xE9j\xE0 leurs colis gr\xE2ce \xE0 TchadBox. Rejoignez-les et offrez le sourire \xE0 vos proches. </p><div class="flex flex-col sm:flex-row gap-4 justify-center" data-v-1bea5839>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/catalogue",
        class: "btn-gold text-lg"
      }, {
...
//# sourceMappingURL=index-Bp7T9mtY.mjs.map
