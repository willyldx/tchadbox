...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, ssrGetDirectiveProps(_ctx, _directive_motion)))}> Saisissez votre num\xE9ro de commande pour suivre son acheminement en temps r\xE9el </p></div></section><div class="container-main py-12 max-w-2xl"><div class="card p-8 mb-8"><form><label class="block text-sm font-medium text-[var(--color-text)] mb-3">Num\xE9ro de commande</label><div class="flex gap-4"><div class="relative flex-grow">`);
      ...
      if (unref(notFound)) {
        ...
        _push(`</div><h3 class="text-xl font-semibold text-[var(--color-text)] mb-2">Commande introuvable</h3><p class="text-[var(--color-text-muted)] mb-6 max-w-sm mx-auto"> V\xE9rifiez votre num\xE9ro de commande et r\xE9essayez. Si le probl\xE8me persiste, notre \xE9quipe est disponible pour vous aider. </p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/contact",
          class: "btn-outline"
        }, {
...
//# sourceMappingURL=suivi-CUiDwH8B.mjs.map
