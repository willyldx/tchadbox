import { c as _export_sfc, l as __nuxt_component_0$2, x as __nuxt_component_1, m as useUI, w as useInjectButtonGroup, t as twMerge, o as appConfig, A as useDebounceFn, B as computedAsync, C as get, p as mergeConfig, D as select, E as selectMenu, F as isEqual } from './server.mjs';
import { resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, createTextVNode, Transition, defineComponent, toRef, computed, ref, toRaw, watch, useId, watchEffect, nextTick, provide, h as h$1, inject, cloneVNode, reactive, useSSRContext } from 'vue';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { d, e } from './form-DsUILy5F.mjs';
import { t as t$2, o as o$2 } from './active-element-history-QtuHblWR.mjs';
import { s as s$2, i as i$4, u as u$1, o as o$1, A as A$1, l, a as i$1, N, w, b as w$2, h, t as t$1, E, T, g as i$2, c as o, n as n$1, O } from './keyboard-BvysMIIh.mjs';
import { u as usePopper, p, a as u$1$1, s, i as i$3, c, f as f$1 } from './usePopper-CIeS2-3g.mjs';
...
let ie = /* @__PURE__ */ Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$12 }) {
  ...
  let M = computed(() => a.multiple ? 1 : 0), $2 = computed(() => a.nullable), [B, p2] = d(computed(() => a.modelValue), (t2) => y("update:modelValue", t2), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u$1(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I(t2) {
  ...
  w([e$1, c$1, f$2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$1(computed(() => u$1(o2.value, { [0]: i$1.Open, [1]: i$1.Closed })));
  computed(() => {
    var t2;
...
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r }) {
  var e2;
  let y = (e2 = a.id) != null ? e2 : `headlessui-combobox-label-${i$4()}`, o2 = K("ComboboxLabel");
  function u2() {
    var c2;
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  var S;
  let o2 = (S = a.id) != null ? S : `headlessui-combobox-button-${i$4()}`, u2 = K("ComboboxButton");
  ...
  var V;
  let u2 = (V = a.id) != null ? V : `headlessui-combobox-input-${i$4()}`, e2 = K("ComboboxInput");
  ...
  i$3({ container: computed(() => o$1(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(S) {
  ...
  return () => {
    ...
    return A$1({ ourProps: v, theirProps: d2, slot: S, attrs: h$12, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r, default: () => [h$1(Ae$1, {}, r.default)] } : r, features: N.RenderStrategy | N.Static, visible: c2.value, name: "ComboboxOptions" });
  };
  ...
  let o2 = K("ComboboxOption"), u$12 = `headlessui-combobox-option-${i$4()}`, e2 = ref(null), c$1 = computed(() => a.disabled);
  y({ el: e2, $el: e2 });
  let f2 = computed(() => {
    var p2;
  ...
  function D(p2) {
    p2.preventDefault(), p2.button === g.Left && (c$1.value || (o2.selectOption(u$12), n$1() || requestAnimationFrame(() => {
      var R;
  ...
  return () => {
    let { disabled: p2 } = a, R = { active: f2.value, selected: S.value, disabled: p2 }, V = { id: u$12, ref: e2, role: "option", tabIndex: p2 === true ? void 0 : -1, "aria-disabled": p2 === true ? true : void 0, "aria-selected": S.value, disabled: void 0, onMousedown: D, onFocus: E2, onPointerenter: M, onMouseenter: M, onPointermove: $2, onMousemove: $2, onPointerleave: B, onMouseleave: B }, i2 = T(a, ["order", "value"]);
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2$1 }) {
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y, L] = d(computed(() => o2.modelValue), (t2) => w$2$1("update:modelValue", t2), computed(() => o2.defaultValue)), M = computed(() => y.value === void 0 ? u$1(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
  ...
  w([f$2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$2(i2, h.Loose) || (t2.preventDefault(), (l2 = o$1(f$2)) == null || l2.focus());
  }, computed(() => n2.value === 0)), provide($, k), t$1(computed(() => u$1(n2.value, { [0]: i$1.Open, [1]: i$1.Closed })));
  computed(() => {
    var t2;
  ...
  return () => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f, E({ features: u.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
...
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r, expose: w2 }) {
  ...
  function v(a) {
    switch (f2.value && clearTimeout(f2.value), a.key) {
      ...
      case o.Enter:
        ...
        break;
      case u$1(e2.orientation.value, { vertical: o.ArrowDown, horizontal: o.ArrowRight }):
        return a.preventDefault(), a.stopPropagation(), e2.goToOption(c.Next);
      case u$1(e2.orientation.value, { vertical: o.ArrowUp, horizontal: o.ArrowLeft }):
  ...
  w2({ el: f2, $el: f2 });
  let v = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s2 = computed(() => u$1(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o2.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o2.value))) }));
  computed(() => u$1(e2.mode.value, { [1]: () => {
    var i2;
...
//# sourceMappingURL=SelectMenu-CHcoscsC.mjs.map
