...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "G\xE9rez vos adresses de livraison TchadBox."
    });
    ...
    watch(() => {
      var _a;
      return (_a = authStore.user) == null ? void 0 : _a.addresses;
    }, (newAddresses) => {
      if (newAddresses) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        _push(`</div><h3 class="text-lg font-semibold text-[var(--color-text)] mb-2">Aucune adresse enregistr\xE9e</h3><p class="text-[var(--color-text-muted)] mb-6">Ajoutez une adresse pour faciliter vos commandes</p><button class="btn-gold">`);
        _push(ssrRenderComponent(unref(Plus), { class: "w-5 h-5" }, null, _parent));
        ...
        ssrRenderList(unref(addresses), (address) => {
          ...
          if (address.isDefault) {
            _push(`<span class="absolute top-4 right-4 text-xs bg-amber-100 text-amber-700 px-2 py-1 rounded-full font-medium"> Par d\xE9faut </span>`);
          } else {
            _push(`<!---->`);
          }
      ...
      _push(`<div><p class="text-sm text-blue-800 font-medium">Livraison au Tchad</p><p class="text-sm text-blue-600 mt-1"> Toutes les livraisons sont effectu\xE9es \xE0 N&#39;Djamena. Pour les autres villes, veuillez nous contacter. </p></div></div></div>`);
...
//# sourceMappingURL=adresses-9FlLGBza.mjs.map
