...
import { o as o$1, g as i$2 } from './keyboard-BvysMIIh.mjs';
...
function f(l, n) {
  ...
  switch (l.focus) {
    ...
    case 1: {
      s2 === -1 && (s2 = t.length);
      for (let e = s2 - 1; e >= 0; --e) if (!n.resolveDisabled(t[e], e, t)) return e;
      return r2;
    }
    case 2: {
      for (let e = s2 + 1; e < t.length; ++e) if (!n.resolveDisabled(t[e], e, t)) return e;
      return r2;
    }
    case 3: {
...
export { u$1 as a, c, f, i, p, s, usePopper as u };
//# sourceMappingURL=usePopper-CIeS2-3g.mjs.map
