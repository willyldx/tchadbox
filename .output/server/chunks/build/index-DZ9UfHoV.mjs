...
import { g as useToast, a as useHead, b as __nuxt_component_3$1, _ as __nuxt_component_3$2, e as __nuxt_component_0$4, n as navigateTo, c as _export_sfc, m as useUI, p as mergeConfig, o as appConfig, I as button } from './server.mjs';
...
import { _ as __nuxt_component_2$1 } from './Dropdown-DjuFUYhZ.mjs';
  ...
  setup(__props) {
    ...
    const filteredOrders = computed(() => {
      ...
      if (search.value) {
        ...
        result = result.filter(
          (o) => {
            var _a, _b, _c, _d, _e;
            return ((_a = o.display_id || String(o.id)) == null ? void 0 : _a.toLowerCase().includes(s)) || ((_b = o.email) == null ? void 0 : _b.toLowerCase().includes(s)) || ((_c = o.customer_first_name) == null ? void 0 : _c.toLowerCase().includes(s)) || ((_d = o.customer_last_name) == null ? void 0 : _d.toLowerCase().includes(s)) || ((_e = o.recipient_name) == null ? void 0 : _e.toLowerCase().includes(s));
          }
        );
      }
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        orders.value = (result == null ? void 0 : result.data) || [];
      } catch (error) {
...
//# sourceMappingURL=index-DZ9UfHoV.mjs.map
