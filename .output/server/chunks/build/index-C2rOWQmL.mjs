  ...
  setup(__props) {
    ...
    const filteredOrders = computed(() => {
      ...
      return orders.value.filter(
        (o) => {
          var _a;
          return (_a = statusMap[statusFilter.value]) == null ? void 0 : _a.includes(o.fulfillmentStatus);
        }
      );
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        _push(`</div><h3 class="text-lg font-semibold text-[var(--color-text)] mb-2">${ssrInterpolate(unref(statusFilter) === "all" ? "Aucune commande" : "Aucune commande avec ce statut")}</h3><p class="text-[var(--color-text-muted)] mb-6">${ssrInterpolate(unref(statusFilter) === "all" ? "Vous n'avez pas encore pass\xE9 de commande." : "Essayez un autre filtre.")}</p>`);
                  ...
                  createVNode("div", { class: "p-6" }, [
                    ...
                    order.fulfillmentStatus === "shipped" ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center justify-between text-xs text-[var(--color-text-muted)] mb-2" }, [
                        ...
                        createVNode("span", null, "Livraison estim\xE9e: " + toDisplayString(estimatedDelivery(order.createdAt)), 1)
                      ]),
...
//# sourceMappingURL=index-C2rOWQmL.mjs.map
