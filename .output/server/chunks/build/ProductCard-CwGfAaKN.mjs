  ...
  setup(__props) {
    ...
    const getCategoryBadgeClass = computed(() => {
      const classes = {
        ...
        "Scolarit\xE9": "bg-blue-50 text-blue-700 border border-blue-200",
        "Sant\xE9 & B\xE9b\xE9": "bg-pink-50 text-pink-700 border border-pink-200",
        "Sant\xE9": "bg-pink-50 text-pink-700 border border-pink-200",
        "F\xEAtes & Occasions": "bg-amber-50 text-amber-700 border border-amber-200",
        "F\xEAtes": "bg-amber-50 text-amber-700 border border-amber-200"
      };
    ...
    const addToCart = () => {
      ...
      cartStore.addItem({
        ...
        thumbnail: props.product.thumbnail || ((_a = props.product.images) == null ? void 0 : _a[0]),
        category: categoryName.value
      });
      toast.add({ title: "Ajout\xE9 au panier", description: props.product.title, icon: "i-heroicons-check-circle", color: "green", timeout: 2500 });
    };
...
//# sourceMappingURL=ProductCard-CwGfAaKN.mjs.map
