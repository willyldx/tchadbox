import { d as useSeoMeta, i as useAuthStore, j as useRoute, e as __nuxt_component_0$4 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="card-glass rounded-2xl shadow-xl p-8"><div class="text-center mb-8"><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2">Bon retour !</h1><p class="text-[var(--color-text-muted)]">Connectez-vous \xE0 votre compte TchadBox</p></div>`);
...
//# sourceMappingURL=login-BWwdAfGU.mjs.map
