...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(emailSent)) {
        _push(`<div class="text-center"><div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6"><svg class="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></div><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2">Email envoy\xE9 !</h1><p class="text-[var(--color-text-muted)] mb-6"> Si un compte existe avec l&#39;adresse <strong>${ssrInterpolate(unref(form).email)}</strong>, vous recevrez un lien de r\xE9initialisation. </p><p class="text-sm text-[var(--color-text-muted)] mb-8"> N&#39;oubliez pas de v\xE9rifier vos spams si vous ne voyez pas l&#39;email. </p><div class="space-y-3"><button class="w-full py-3 btn-outline"> Essayer une autre adresse </button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/auth/login",
        ...
        _push(`<div><div class="text-center mb-8"><div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6"><svg class="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path></svg></div><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2">Mot de passe oubli\xE9 ?</h1><p class="text-[var(--color-text-muted)]">Entrez votre email et nous vous enverrons un lien de r\xE9initialisation.</p></div>`);
        if (unref(error)) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"${_scopeId}></path></svg> Retour \xE0 la connexion `);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  class: "w-4 h-4",
...
//# sourceMappingURL=mot-de-passe-oublie-De3krdFi.mjs.map
