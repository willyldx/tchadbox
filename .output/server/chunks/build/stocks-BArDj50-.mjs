import { g as useToast, a as useHead, b as __nuxt_component_3$1, l as __nuxt_component_0$2, _ as __nuxt_component_3$2, c as _export_sfc, m as useUI, t as twMerge, o as appConfig, p as mergeConfig, q as textarea, r as looseToNumber } from './server.mjs';
...
import { defineComponent, ref, reactive, computed, withCtx, createTextVNode, unref, isRef, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, mergeProps, toRef, watch, nextTick, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        products.value = (result == null ? void 0 : result.data) || [];
      } catch (error) {
    ...
    const createProduct = async () => {
      ...
      try {
        ...
        toast.add({ title: "Succ\xE8s", description: "Produit cr\xE9\xE9 avec succ\xE8s", color: "green" });
        ...
        toast.add({ title: "Erreur", description: ((_a = error == null ? void 0 : error.data) == null ? void 0 : _a.message) || error.message || "Impossible de cr\xE9er le produit", color: "red" });
      } finally {
    ...
    const onImageSelected = async (e) => {
      ...
      try {
        ...
        toast.add({ title: "Aper\xE7u g\xE9n\xE9r\xE9", description: `L'image est pr\xEAte !`, color: "green" });
      } catch (error) {
        console.error("Upload failed:", error);
        toast.add({ title: "Erreur", description: `Impossible de t\xE9l\xE9charger l'image.`, color: "red" });
      } finally {
        uploadingImage.value = false;
      }
    };
    const deleteProduct = async (product) => {
      if (!confirm(`Supprimer "${product.title}" ? Cette action est irr\xE9versible.`)) return;
      try {
        await api.adminProductDelete(product.id);
        toast.add({ title: "Supprim\xE9", description: "Produit supprim\xE9", color: "green" });
        fetchProducts();
      } catch (error) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<p class="text-gray-500">Aucun produit trouv\xE9</p><p class="text-sm text-gray-400 mt-1">Cliquez sur &quot;Ajouter un produit&quot; pour commencer</p></div>`);
      } else {
      ...
      _push(ssrRenderComponent(_component_UModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="grid grid-cols-2 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Cat\xE9gorie</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(createForm).category,
              "onUpdate:modelValue": ($event) => unref(createForm).category = $event,
              placeholder: "Ex: Alimentaire"
            }, null, _parent2, _scopeId));
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Slug cat\xE9gorie</label>`);
            _push2(ssrRenderComponent(_component_UInput, {
            ...
            if (unref(createForm).thumbnail) {
              _push2(`<img${ssrRenderAttr("src", unref(createForm).thumbnail)} class="h-20 w-20 object-cover rounded-md border border-gray-200" alt="Aper\xE7u"${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(ssrRenderComponent(_component_UTextarea, {
              ...
              rows: 3,
              placeholder: "Description d\xE9taill\xE9e du produit..."
            }, null, _parent2, _scopeId));
            _push2(`</div></div><div class="flex justify-end gap-3 mt-6"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UButton, {
              color: "gray",
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Cr\xE9er le produit`);
                } else {
                  return [
                    createTextVNode("Cr\xE9er le produit")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "p-6" }, [
                ...
                createVNode("div", { class: "space-y-4 max-h-[60vh] overflow-y-auto pr-2" }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Cat\xE9gorie"),
                      createVNode(_component_UInput, {
                        modelValue: unref(createForm).category,
                        "onUpdate:modelValue": ($event) => unref(createForm).category = $event,
                        placeholder: "Ex: Alimentaire"
                    ...
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Slug cat\xE9gorie"),
                      createVNode(_component_UInput, {
                        modelValue: unref(createForm).category_handle,
                        "onUpdate:modelValue": ($event) => unref(createForm).category_handle = $event,
                        placeholder: "Ex: alimentaire"
...
//# sourceMappingURL=stocks-BArDj50-.mjs.map
