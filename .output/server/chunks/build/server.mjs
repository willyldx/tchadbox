import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, shallowRef, ref, watchEffect, computed, getCurrentInstance, watch, nextTick, defineComponent, h, hasInjectionContext, inject, useAttrs, toValue as toValue$1, provide, onServerPrefetch, resolveComponent, toRef, mergeProps, createVNode, resolveDynamicComponent, unref, reactive, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, toRefs, markRaw, createElementBlock, cloneVNode, defineAsyncComponent, useSlots, Fragment, shallowReactive, Suspense, useSSRContext, createApp, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode, onErrorCaptured, createSlots, renderList, readonly, shallowReadonly, onUnmounted, onMounted, isReadonly, isShallow } from 'vue';
import { z as hasProtocol, A as isScriptProtocol, y as joinURL, B as defuFn, C as defu, D as klona, E as parseQuery, F as withQuery, G as sanitizeStatusCode, H as parseURL, I as encodePath, J as decodePath, K as createDefu, L as getContext, M as withTrailingSlash, N as withoutTrailingSlash, e as createError$1, $ as $fetch$1, O as baseURL, P as createHooks, Q as executeAsync } from '../_/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrInterpolate, ssrRenderSlot, ssrRenderTeleport, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    component: () => import('./403-CFHMUch-.mjs')
  },
  {
    name: "404",
    path: "/404",
    meta: __nuxt_page_meta$i || {},
    component: () => import('./404-DD-M4Wl_.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bp7T9mtY.mjs')
  },
  {
    name: "suivi",
    path: "/suivi",
    component: () => import('./suivi-CiwDwjtF.mjs')
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import('./panier-Wyzw2rwj.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BQMjFzqZ.mjs')
  },
  {
    name: "favoris",
    path: "/favoris",
    component: () => import('./favoris-w1_sRfGO.mjs')
  },
  {
    name: "catalogue",
    path: "/catalogue",
    component: () => import('./catalogue-D_mS8-zu.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./login-B8YMZM2L.mjs')
  },
  {
    name: "conditions",
    path: "/conditions",
    component: () => import('./conditions-D_OuyGpb.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$g || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-BH6wW85I.mjs')
  },
  {
    name: "admin-equipe",
    path: "/admin/equipe",
    meta: { ...__nuxt_page_meta$f || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./equipe-U6BM9gA7.mjs')
  },
  {
    name: "admin-stocks",
    path: "/admin/stocks",
    meta: { ...__nuxt_page_meta$e || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./stocks-BArDj50-.mjs')
  },
  {
    name: "compte",
    path: "/compte",
    meta: { "middleware": ["auth"] },
    component: () => import('./index-BlgP1JrI.mjs')
  },
  {
    name: "livreur-id",
    path: "/livreur/:id()",
    meta: { ...__nuxt_page_meta$d || {}, ...{ "middleware": ["livreur"] } },
    component: () => import('./_id_-AD7zLEQk.mjs')
  },
  {
    name: "admin-clients",
    path: "/admin/clients",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./clients-B9tvoPj5.mjs')
  },
  {
    name: "auth-callback",
    path: "/auth/callback",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./callback-C3D2unRy.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./register-DNUBcCJD.mjs')
  },
  {
    name: "compte-profil",
    path: "/compte/profil",
    meta: { "middleware": ["auth"] },
    component: () => import('./profil-D6PhbzBH.mjs')
  },
  {
    name: "livreur",
    path: "/livreur",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import('./index-U1pxsgm6.mjs')
  },
  {
    name: "admin-finances",
    path: "/admin/finances",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./finances-kSJkTzaT.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": ["auth"] } },
    component: () => import('./index-BmJq0TTY.mjs')
  },
  {
    name: "livreur-profil",
    path: "/livreur/profil",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import('./profil-CfweHI0m.mjs')
  },
  {
    name: "produit-slug",
    path: "/produit/:slug()",
    component: () => import('./_slug_-BsjvgzU-.mjs')
  },
  {
    name: "compte-adresses",
    path: "/compte/adresses",
    meta: { "middleware": ["auth"] },
    component: () => import('./adresses-9FlLGBza.mjs')
  },
  {
    name: "confidentialite",
    path: "/confidentialite",
    component: () => import('./confidentialite-BEyFtQiJ.mjs')
  },
  {
    name: "mentions-legales",
    path: "/mentions-legales",
    component: () => import('./mentions-legales-DR7PCOJB.mjs')
  },
  {
    name: "comment-ca-marche",
    path: "/comment-ca-marche",
    component: () => import('./comment-ca-marche-_hu-hzZk.mjs')
  },
  {
    name: "livreur-historique",
    path: "/livreur/historique",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import('./historique-JpWLsu-P.mjs')
  },
  {
    name: "admin-commandes-id",
    path: "/admin/commandes/:id()",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./_id_-Bh5ffSTK.mjs')
  },
  {
    name: "admin-livreurs",
    path: "/admin/livreurs",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-DEzHrd1s.mjs')
  },
  {
    name: "admin-commandes",
    path: "/admin/commandes",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-DZ9UfHoV.mjs')
  },
  {
    name: "checkout-confirmation",
    path: "/checkout/confirmation",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./confirmation-CG-Zdh4a.mjs')
  },
  {
    name: "compte-commandes-id",
    path: "/compte/commandes/:id()",
    meta: { "middleware": ["auth"] },
    component: () => import('./_id_-C78A6ort.mjs')
  },
  {
    name: "compte-commandes",
    path: "/compte/commandes",
    meta: { "middleware": ["auth"] },
    component: () => import('./index-DuRbrxzO.mjs')
  },
  {
    name: "auth-mot-de-passe-oublie",
    path: "/auth/mot-de-passe-oublie",
    meta: __nuxt_page_meta || {},
    component: () => import('./mot-de-passe-oublie-XeoXJ6os.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-C42VE7P0.mjs'),
  auth: () => import('./auth-Dg8RMBSh.mjs'),
  livreur: () => import('./livreur-C6JqLYy8.mjs')
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-DJA6P97q.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-D6IDjGB3.mjs').then((m) => m.default || m)),
  livreur: defineAsyncComponent(() => import('./livreur-BTLQQxEb.mjs').then((m) => m.default || m))
};
...
const server = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	...
	_: __nuxt_component_3$2,
	a: useHead,
	b: __nuxt_component_3$1,
	c: useSeoMeta,
	d: __nuxt_component_0$4,
	...
	u: useRouter,
	v: useNuxtApp,
	w: useInjectButtonGroup,
	x: arrow,
	y: __nuxt_component_1,
	z: getNuxtLinkProps
}, Symbol.toStringTag, { value: 'Module' }));

export { useDebounceFn as A, computedAsync as B, get as C, select as D, selectMenu as E, isEqual as F, input as G, useVModel as H, button as I, defineNuxtRouteMiddleware as J, server as K, __nuxt_component_3$2 as _, useHead as a, __nuxt_component_3$1 as b, _export_sfc as c, useSeoMeta as d, __nuxt_component_0$4 as e, useCartStore as f, useToast as g, useFavoritesStore as h, useAuthStore as i, useRoute as j, useRuntimeConfig as k, __nuxt_component_0$2 as l, useUI as m, navigateTo as n, appConfig as o, mergeConfig as p, textarea as q, looseToNumber as r, useSupabase as s, twMerge as t, useRouter as u, useNuxtApp as v, useInjectButtonGroup as w, __nuxt_component_1 as x, getNuxtLinkProps as y, arrow as z };
