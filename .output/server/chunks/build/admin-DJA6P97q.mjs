import { i as useAuthStore, j as useRoute, _ as __nuxt_component_3$2, e as __nuxt_component_0$4, b as __nuxt_component_3$1, n as navigateTo } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const superAdminItems = [
      { to: "/admin/equipe", label: "\xC9quipe", icon: "lucide:user-cog" },
    ...
    const roleLabel = computed(() => {
      const roles = {
        super_admin: "\u{1F451} CEO",
        admin: "\u{1F6E1}\uFE0F Admin",
        livreur: "\u{1F69A} Livreur",
        client: "Client"
      };
...
//# sourceMappingURL=admin-DJA6P97q.mjs.map
