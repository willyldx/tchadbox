import { resolveComponent, mergeProps, withCtx, createVNode, renderSlot, openBlock, createBlock, createCommentVNode, defineComponent, toRef, computed, useId, ref, h, watchEffect, provide, normalizeClass, inject, nextTick, watch, getCurrentInstance, Teleport, reactive, Fragment, shallowRef, useSSRContext } from 'vue';
import { s as s$2, e as s2, S, i as i$4, u as u$1$1, t as t$1, a as i$1, f as c$1, A as A$2, N as N$3, l as l$1, T as T$1, g as i$2, o as o$1, w as w$1, j as S$1, k as w$1$1, P, d as N$1$1, c as o$2, m as t$1$2 } from './keyboard-BvysMIIh.mjs';
import { f as f$1, u as u$2 } from './hidden-CZ0WYEIB.mjs';
import { t as t$2, a as t$1$1, o } from './active-element-history-QtuHblWR.mjs';
import { k } from './description-DXB91rC2.mjs';
import { c as _export_sfc, m as useUI, p as mergeConfig, o as appConfig } from './server.mjs';
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s2.value ? P(o$1(o$12), u$1$1(f2.value, { [d$2.Forwards]: () => N$1$1.Next, [d$2.Backwards]: () => N$1$1.Previous }) | N$1$1.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S$1(u2.target)));
  }
  return () => {
...
function w() {
  return t$1$2() ? { before({ doc: r, d: n2, meta: c2 }) {
    function a2(o2) {
...
let A = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p, expose: s$12 }) {
  ...
  E(oe, ae), R$1({ type: "Dialog", enabled: computed(() => c2.value === 0), element: m2, onUpdate: (e2, a2) => {
    if (a2 === "Dialog") return u$1$1(e2, { [s.Add]: () => D.value += 1, [s.Remove]: () => D.value -= 1 });
  } });
  ...
  return d$1(E$2, ue$1, (e2) => {
    ...
    return h(u$1, { force: true }, () => [h($, () => h(z, { target: m2.value }, () => h(u$1, { force: false }, () => h(ue, { initialFocus: a2, containers: B2, features: k$1.value ? u$1$1(ee.value, { parent: ue.features.RestoreFocus, leaf: ue.features.All & ~ue.features.FocusLock }) : ue.features.None }, () => h(X, {}, () => A$2({ ourProps: f2, theirProps: { ...d2, ...l2 }, slot: L2, attrs: l2, slots: p, visible: c2.value === 0, features: N$3.RenderStrategy | N$3.Static, name: "Dialog" })))))), h(Z)]);
  };
} });
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s2$1, expose: h$1 }) {
  ...
  g(e2.leaveFrom);
  g(e2.leaveTo);
  return provide(N, P2), t$1(computed(() => u$1$1(i2.value, { ["visible"]: i$1.Open, ["hidden"]: i$1.Closed }) | n2.value)), () => {
...
//# sourceMappingURL=Modal-D6oFe3LW.mjs.map
