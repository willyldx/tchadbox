import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, toValue as toValue$1, onServerPrefetch, unref, resolveComponent, defineAsyncComponent, onUnmounted, onMounted, useSlots, Fragment, shallowReadonly, watchEffect, readonly, Suspense, mergeProps, withCtx, createVNode, useSSRContext, useAttrs, resolveDynamicComponent, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createSlots, renderList, createTextVNode, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/h3/dist/index.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/ufo/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu, defuFn, createDefu } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/defu/dist/defu.mjs";
import { klona } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/klona/dist/index.mjs";
...
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { ssrRenderTeleport, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrRenderSlot, ssrRenderSuspense } from "vue/server-renderer";
import { ShoppingBag, X, Truck, Check, Package, Trash2, Minus, Plus } from "lucide-vue-next";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { debounce } from "C:/Users/adoum/Desktop/Free Project/tchadbox/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/403-CFHMUch-.js")
  },
  {
    name: "404",
    path: "/404",
    meta: __nuxt_page_meta$i || {},
    component: () => import("./_nuxt/404-DD-M4Wl_.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Bp7T9mtY.js")
  },
  {
    name: "suivi",
    path: "/suivi",
    component: () => import("./_nuxt/suivi-CiwDwjtF.js")
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import("./_nuxt/panier-Wyzw2rwj.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BQMjFzqZ.js")
  },
  {
    name: "favoris",
    path: "/favoris",
    component: () => import("./_nuxt/favoris-w1_sRfGO.js")
  },
  {
    name: "catalogue",
    path: "/catalogue",
    component: () => import("./_nuxt/catalogue-D_mS8-zu.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": ["auth"] } },
    component: () => import("./_nuxt/login-B8YMZM2L.js")
  },
  {
    name: "conditions",
    path: "/conditions",
    component: () => import("./_nuxt/conditions-D_OuyGpb.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$g || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/index-BH6wW85I.js")
  },
  {
    name: "admin-equipe",
    path: "/admin/equipe",
    meta: { ...__nuxt_page_meta$f || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/equipe-U6BM9gA7.js")
  },
  {
    name: "admin-stocks",
    path: "/admin/stocks",
    meta: { ...__nuxt_page_meta$e || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/stocks-BArDj50-.js")
  },
  {
    name: "compte",
    path: "/compte",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/index-BlgP1JrI.js")
  },
  {
    name: "livreur-id",
    path: "/livreur/:id()",
    meta: { ...__nuxt_page_meta$d || {}, ...{ "middleware": ["livreur"] } },
    component: () => import("./_nuxt/_id_-AD7zLEQk.js")
  },
  {
    name: "admin-clients",
    path: "/admin/clients",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/clients-B9tvoPj5.js")
  },
  {
    name: "auth-callback",
    path: "/auth/callback",
    meta: __nuxt_page_meta$b || {},
    component: () => import("./_nuxt/callback-C3D2unRy.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": ["auth"] } },
    component: () => import("./_nuxt/register-DNUBcCJD.js")
  },
  {
    name: "compte-profil",
    path: "/compte/profil",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/profil-D6PhbzBH.js")
  },
  {
    name: "livreur",
    path: "/livreur",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import("./_nuxt/index-U1pxsgm6.js")
  },
  {
    name: "admin-finances",
    path: "/admin/finances",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/finances-kSJkTzaT.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": ["auth"] } },
    component: () => import("./_nuxt/index-BmJq0TTY.js")
  },
  {
    name: "livreur-profil",
    path: "/livreur/profil",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import("./_nuxt/profil-CfweHI0m.js")
  },
  {
    name: "produit-slug",
    path: "/produit/:slug()",
    component: () => import("./_nuxt/_slug_-BsjvgzU-.js")
  },
  {
    name: "compte-adresses",
    path: "/compte/adresses",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/adresses-9FlLGBza.js")
  },
  {
    name: "confidentialite",
    path: "/confidentialite",
    component: () => import("./_nuxt/confidentialite-BEyFtQiJ.js")
  },
  {
    name: "mentions-legales",
    path: "/mentions-legales",
    component: () => import("./_nuxt/mentions-legales-DR7PCOJB.js")
  },
  {
    name: "comment-ca-marche",
    path: "/comment-ca-marche",
    component: () => import("./_nuxt/comment-ca-marche-_hu-hzZk.js")
  },
  {
    name: "livreur-historique",
    path: "/livreur/historique",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["livreur"] } },
    component: () => import("./_nuxt/historique-JpWLsu-P.js")
  },
  {
    name: "admin-commandes-id",
    path: "/admin/commandes/:id()",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/_id_-Bh5ffSTK.js")
  },
  {
    name: "admin-livreurs",
    path: "/admin/livreurs",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/index-DEzHrd1s.js")
  },
  {
    name: "admin-commandes",
    path: "/admin/commandes",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["admin"] } },
    component: () => import("./_nuxt/index-DZ9UfHoV.js")
  },
  {
    name: "checkout-confirmation",
    path: "/checkout/confirmation",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/confirmation-CG-Zdh4a.js")
  },
  {
    name: "compte-commandes-id",
    path: "/compte/commandes/:id()",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/_id_-C78A6ort.js")
  },
  {
    name: "compte-commandes",
    path: "/compte/commandes",
    meta: { "middleware": ["auth"] },
    component: () => import("./_nuxt/index-DuRbrxzO.js")
  },
  {
    name: "auth-mot-de-passe-oublie",
    path: "/auth/mot-de-passe-oublie",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/mot-de-passe-oublie-XeoXJ6os.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-C42VE7P0.js"),
  auth: () => import("./_nuxt/auth-Dg8RMBSh.js"),
  livreur: () => import("./_nuxt/livreur-C6JqLYy8.js")
};
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-DJA6P97q.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-D6IDjGB3.js").then((m) => m.default || m)),
  livreur: defineAsyncComponent(() => import("./_nuxt/livreur-BTLQQxEb.js").then((m) => m.default || m))
};
...
const useCartStore = /* @__PURE__ */ defineStore("cart", {
  ...
  actions: {
    ...
    async fetchRates() {
      try {
        const data = await $fetch("https://api.exchangerate-api.com/v4/latest/EUR", {
          timeout: 5e3
        });
        if (data?.rates) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(cartStore).isOpen) {
          _push2(`<div class="fixed inset-0 bg-black/40 backdrop-blur-sm z-50"></div>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(cartStore).isOpen) {
          _push2(`<div class="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col"><div class="flex items-center justify-between p-6 border-b border-gray-100"><div class="flex items-center gap-3"><div class="w-10 h-10 rounded-full bg-amber-500/10 flex items-center justify-center">`);
          _push2(ssrRenderComponent(unref(ShoppingBag), { class: "w-5 h-5 text-[var(--color-primary)]" }, null, _parent));
          _push2(`</div><div><h2 class="text-lg font-semibold text-[var(--color-text)]">Mon Panier</h2>`);
          if (unref(cartStore).itemCount > 0) {
            _push2(`<p class="text-sm text-[var(--color-text-muted)]">${ssrInterpolate(unref(cartStore).itemCount)} article${ssrInterpolate(unref(cartStore).itemCount > 1 ? "s" : "")}</p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div><button class="p-2 rounded-full hover:bg-gray-100 transition-colors">`);
          _push2(ssrRenderComponent(unref(X), { class: "w-5 h-5 text-gray-500" }, null, _parent));
          _push2(`</button></div>`);
          if (!unref(cartStore).isEmpty) {
            _push2(`<div class="px-6 py-4 bg-amber-50/50 border-b border-amber-100"><div class="flex items-center justify-between mb-2"><span class="text-xs font-medium text-amber-800 flex items-center gap-1.5">`);
            if (unref(cartStore).amountToFreeShipping > 0) {
              _push2(`<!--[-->`);
              _push2(ssrRenderComponent(unref(Truck), { class: "w-3.5 h-3.5" }, null, _parent));
              _push2(` Plus que <span class="font-bold">${ssrInterpolate(unref(cartStore).formatPrice(unref(cartStore).amountToFreeShipping))}</span> pour la livraison offerte ! <!--]-->`);
            } else {
              _push2(`<!--[--><div class="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center">`);
              _push2(ssrRenderComponent(unref(Check), { class: "w-2.5 h-2.5 text-white" }, null, _parent));
              _push2(`</div> Félicitations ! La livraison est <span class="font-bold uppercase">offerte</span><!--]-->`);
            }
            _push2(`</span><span class="text-[10px] font-bold text-amber-600 bg-white px-1.5 py-0.5 rounded shadow-sm"> Objectif: ${ssrInterpolate(unref(cartStore).formatPrice(unref(cartStore).freeShippingThreshold))}</span></div><div class="h-2 w-full bg-amber-100 rounded-full overflow-hidden shadow-inner"><div class="h-full bg-gradient-to-r from-amber-400 to-amber-500 transition-all duration-1000 ease-out relative" style="${ssrRenderStyle({ width: `${unref(cartStore).freeShippingProgress}%` })}"><div class="absolute inset-0 bg-white/20 animate-pulse"></div></div></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div class="flex-grow overflow-y-auto">`);
          if (unref(cartStore).isEmpty) {
            _push2(`<div class="flex flex-col items-center justify-center h-full p-8 text-center"><div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mb-4">`);
            _push2(ssrRenderComponent(unref(ShoppingBag), { class: "w-8 h-8 text-gray-400" }, null, _parent));
            _push2(`</div><h3 class="font-semibold text-[var(--color-text)] mb-2">Panier vide</h3><p class="text-[var(--color-text-muted)] text-sm mb-6">Découvrez nos produits</p>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/catalogue",
              class: "btn-primary",
              onClick: unref(cartStore).closeCart
            }, {
              default: withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`<span${_scopeId}>Voir le catalogue</span>`);
                } else {
                  return [
                    createVNode("span", null, "Voir le catalogue")
                  ];
                }
              }),
              _: 1
            ...
            _push2(`<div class="p-4 space-y-3"><!--[-->`);
            ssrRenderList(unref(cartStore).items, (item) => {
              _push2(`<div class="flex gap-4 p-4 rounded-xl bg-gray-50 border border-gray-100"><div class="w-16 h-16 rounded-lg bg-white flex items-center justify-center flex-shrink-0 border border-gray-100">`);
              if (item.thumbnail) {
                _push2(`<img${ssrRenderAttr("src", item.thumbnail)}${ssrRenderAttr("alt", item.title)} class="w-full h-full object-cover rounded-lg">`);
              } else {
                _push2(ssrRenderComponent(unref(Package), { class: "w-6 h-6 text-gray-300" }, null, _parent));
              }
              _push2(`</div><div class="flex-grow min-w-0"><h4 class="font-medium text-[var(--color-text)] text-sm truncate">${ssrInterpolate(item.title)}</h4><p class="text-xs text-[var(--color-text-muted)]">${ssrInterpolate(item.category)}</p><p class="font-semibold text-[var(--color-primary)] text-sm mt-1">${ssrInterpolate(_ctx.formatPrice(item.price))}</p></div><div class="flex flex-col items-end justify-between"><button class="p-1 text-gray-400 hover:text-red-500 transition-colors">`);
              _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent));
              _push2(`</button><div class="flex items-center gap-1 bg-white rounded-lg border border-gray-200 p-0.5"><button class="w-7 h-7 rounded flex items-center justify-center hover:bg-gray-100">`);
              _push2(ssrRenderComponent(unref(Minus), { class: "w-3 h-3" }, null, _parent));
              _push2(`</button><span class="w-6 text-center text-sm font-medium">${ssrInterpolate(item.quantity)}</span><button class="w-7 h-7 rounded flex items-center justify-center hover:bg-gray-100">`);
          ...
          _push2(`</div>`);
          if (!unref(cartStore).isEmpty) {
            _push2(`<div class="border-t border-gray-100 p-6 bg-gray-50"><div class="space-y-3 mb-6"><div class="flex justify-between text-[var(--color-text-secondary)]"><span>Sous-total</span><span>${ssrInterpolate(unref(cartStore).formattedSubtotal)}</span></div><div class="flex justify-between text-[var(--color-text-secondary)]"><span class="flex items-center gap-2">`);
            _push2(ssrRenderComponent(unref(Truck), { class: "w-4 h-4" }, null, _parent));
            _push2(`Livraison</span><span>${ssrInterpolate(unref(cartStore).formattedShipping)}</span></div><div class="border-t border-gray-200 pt-3 flex justify-between"><span class="font-semibold text-[var(--color-text)]">Total</span><div class="text-right"><span class="text-xl font-bold text-[var(--color-primary)]">${ssrInterpolate(unref(cartStore).formattedTotal)}</span>`);
            if (unref(cartStore).currency !== "XAF") {
              _push2(`<p class="text-xs text-[var(--color-text-muted)]">≈ ${ssrInterpolate(unref(cartStore).totalXAF)} FCFA</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/panier",
              class: "btn-primary w-full text-center mb-3",
              onClick: unref(cartStore).closeCart
            }, {
              default: withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`<span${_scopeId}>Finaliser la commande</span>`);
                } else {
                  return [
                    createVNode("span", null, "Finaliser la commande")
                  ];
                }
              }),
              _: 1
            }, _parent));
            _push2(`<button class="btn-ghost w-full">Continuer mes achats</button></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
...
const useAuthStore = /* @__PURE__ */ defineStore("auth", {
  ...
  actions: {
    ...
    async syncWithClerk(isSignedIn, clerkUser) {
      this.isAuthenticated = !!isSignedIn;
      if (isSignedIn && clerkUser) {
        const metadataRole = clerkUser.publicMetadata?.role || "client";
        this.user = {
          id: clerkUser.id,
          ...
          role: metadataRole,
          createdAt: clerkUser.createdAt ? new Date(clerkUser.createdAt).toISOString() : (/* @__PURE__ */ new Date()).toISOString(),
          addresses: []
        };
    ...
    async login(email, password) {
      ...
      this.error = null;
      try {
        if (!(void 0).Clerk) throw new Error("Clerk is not loaded");
        const activeSessions = (void 0).Clerk.client?.activeSessions;
        if (activeSessions && activeSessions.length > 0) {
          const existingSession = activeSessions[0];
          await (void 0).Clerk.setActive({ session: existingSession.id });
          await new Promise((resolve) => setTimeout(resolve, 300));
          this.syncWithClerk(true, (void 0).Clerk.user);
          return { success: true, role: this.userRole };
        }
        const signInAttempt = await (void 0).Clerk.client.signIn.create({
          identifier: email,
          password
        });
        if (signInAttempt.status === "complete") {
          await (void 0).Clerk.setActive({ session: signInAttempt.createdSessionId });
          this.syncWithClerk(true, (void 0).Clerk.user);
          return { success: true, role: this.userRole };
        } else if (["needs_first_factor", "needs_second_factor", "needs_client_trust"].includes(signInAttempt.status)) {
          const emailFactor = signInAttempt.supportedFirstFactors?.find((f) => f.strategy === "email_code");
          if (emailFactor) {
            await (void 0).Clerk.client.signIn.prepareFirstFactor({
              strategy: "email_code",
        ...
        if (errorCode === "session_exists") {
          try {
            const sessions = (void 0).Clerk?.client?.activeSessions;
            if (sessions && sessions.length > 0) {
              await (void 0).Clerk.setActive({ session: sessions[0].id });
              await new Promise((resolve) => setTimeout(resolve, 300));
              this.syncWithClerk(true, (void 0).Clerk.user);
              return { success: true, role: this.userRole };
            }
    ...
    async register(data) {
      ...
      try {
        ...
        const signUpAttempt = await (void 0).Clerk.client.signUp.create({
          emailAddress: data.email,
          password: data.password,
          firstName: data.firstName,
          lastName: data.lastName
        });
        await (void 0).Clerk.client.signUp.prepareEmailAddressVerification({ strategy: "email_code" });
        if (signUpAttempt.status === "complete") {
          await (void 0).Clerk.setActive({ session: signUpAttempt.createdSessionId });
          this.syncWithClerk(true, (void 0).Clerk.user);
          return { success: true, requiresConfirmation: false };
    ...
    async verifyEmail(code) {
      ...
      try {
        if (!(void 0).Clerk) throw new Error("Clerk is not loaded");
        const completeSignUp = await (void 0).Clerk.client.signUp.attemptEmailAddressVerification({ code });
        if (completeSignUp.status === "complete") {
          await (void 0).Clerk.setActive({ session: completeSignUp.createdSessionId });
          this.syncWithClerk(true, (void 0).Clerk.user);
          return { success: true };
        } else {
    ...
    async verifySignIn(code) {
      this.isLoading = true;
      this.error = null;
      try {
        if (!(void 0).Clerk) throw new Error("Clerk is not loaded");
        const completeSignIn = await (void 0).Clerk.client.signIn.attemptFirstFactor({
          strategy: "email_code",
          code
        });
        if (completeSignIn.status === "complete") {
          await (void 0).Clerk.setActive({ session: completeSignIn.createdSessionId });
          this.syncWithClerk(true, (void 0).Clerk.user);
          return { success: true };
        } else {
    ...
    async updateProfile(updates) {
      ...
      try {
        if ((void 0).Clerk && (void 0).Clerk.user) {
          await (void 0).Clerk.user.update({
    ...
    async requestPasswordReset(email) {
      try {
        if (!(void 0).Clerk) throw new Error("Clerk not loaded");
        await (void 0).Clerk.client.signIn.create({
...
function useSupabase() {
  const mockChain = {
    ...
    then: (resolve) => resolve({ data: null, error: new Error("Supabase is deprecated") })
  };
  const client = {
    from: () => mockChain,
  ...
  actions: {
    ...
    async addToFavorites(product) {
      ...
      const item = {
        ...
        category: "category" in product && product.category ? product.category.name : product.category,
    ...
    async removeFromFavorites(productId) {
      const index2 = this.items.findIndex((item) => item.productId === productId);
      if (index2 > -1) {
    ...
    async syncWithServer() {
      ...
      try {
        const { data: serverFavorites, error } = await client.from("favorites").select("product_id, created_at").eq("user_id", authStore.user.id);
        if (error) {
    ...
    async addToServerFavorites(userId, productId) {
      const { client } = useSupabase();
      try {
    ...
    async removeFromServerFavorites(userId, productId) {
      const { client } = useSupabase();
      try {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CartDrawer = _sfc_main$9;
      const _component_UNotifications = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[var(--color-bg)]" }, _attrs))}>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[var(--color-bg)] flex items-center justify-center p-4" }, _attrs))}><div class="text-center max-w-lg"><div class="relative mb-8"><div class="text-[120px] font-bold text-[var(--color-border)] leading-none select-none">${ssrInterpolate(__props.error?.statusCode || "500")}</div><div class="absolute inset-0 flex items-center justify-center"><div class="w-28 h-28 bg-red-100 rounded-full flex items-center justify-center"><svg class="w-14 h-14 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg></div></div></div><h1 class="text-3xl font-bold text-[var(--color-text)] mb-4">${ssrInterpolate(__props.error?.statusCode === 404 ? "Page introuvable" : "Une erreur est survenue")}</h1><p class="text-[var(--color-text-muted)] mb-8">${ssrInterpolate(__props.error?.statusCode === 404 ? "Cette page n'existe pas ou a été déplacée." : "Nous rencontrons un problème technique. Veuillez réessayer plus tard.")}</p><div class="flex flex-col sm:flex-row gap-4 justify-center"><button class="btn-gold"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg> Retour à l&#39;accueil </button><button class="btn-outline"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg> Voir le catalogue </button></div>`);
      if (__props.error?.message && unref(isDev)) {
        _push(`<div class="mt-12 p-4 bg-red-50 rounded-xl text-left"><p class="text-xs text-red-500 font-mono break-all">${ssrInterpolate(__props.error.message)}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<p class="text-sm text-[var(--color-text-muted)] mt-12"> Besoin d&#39;aide ? `);
...
export {
  ...
  __nuxt_component_3$2 as _,
  useHead as a,
  __nuxt_component_3$1 as b,
  useSeoMeta as c,
  __nuxt_component_0$4 as d,
  entry_default as default,
  _export_sfc as e,
  useCartStore as f,
  useToast as g,
  useFavoritesStore as h,
  useAuthStore as i,
  useRuntimeConfig as j,
  useRoute as k,
  __nuxt_component_0$2 as l,
  useUI as m,
  navigateTo as n,
  appConfig as o,
  mergeConfig as p,
  ...
  useRouter as u,
  useNuxtApp as v,
  useInjectButtonGroup as w,
  arrow as x,
  __nuxt_component_1 as y,
  getNuxtLinkProps as z
};
