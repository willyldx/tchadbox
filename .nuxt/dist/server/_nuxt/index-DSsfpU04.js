...
import { _ as _sfc_main$1 } from "./ProductCard-CwGfAaKN.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><div class="orb orb-amber w-96 h-96 -top-20 right-0 animate-float" style="${ssrRenderStyle({ "z-index": "2" })}" data-v-0641c9ec></div><div class="container-main relative z-10 py-20" data-v-0641c9ec><div class="max-w-2xl" data-v-0641c9ec><div class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-8" data-v-0641c9ec><span class="w-2 h-2 rounded-full bg-green-400 animate-pulse" data-v-0641c9ec></span><span class="text-sm font-medium text-white/90" data-v-0641c9ec>🇹🇩 Service de livraison premium à N&#39;Djamena — Preuve photo garantie</span></div><div class="relative min-h-[180px] md:min-h-[160px]" data-v-0641c9ec><!--[--><div data-v-0641c9ec><h1 class="heading-hero text-white mb-6" data-v-0641c9ec>${heroSlides[unref(currentSlide)].title ?? ""}</h1><p class="text-xl text-white/80 mb-10 max-w-lg leading-relaxed" data-v-0641c9ec>${ssrInterpolate(heroSlides[unref(currentSlide)].subtitle)}</p></div><!--]--></div><div class="flex flex-col sm:flex-row gap-4" data-v-0641c9ec>`);
      ...
      _push(`<!--]--></div></div></section><section class="py-20 bg-[var(--color-bg-warm)]" data-v-0641c9ec><div class="container-main" data-v-0641c9ec><div class="text-center mb-14" data-v-0641c9ec><span class="label mb-3 block" data-v-0641c9ec>Nos gammes</span><h2 class="heading-section" data-v-0641c9ec>Explorez nos <span class="text-gradient" data-v-0641c9ec>catégories</span></h2><p class="text-[var(--color-text-muted)] mt-3 max-w-lg mx-auto" data-v-0641c9ec> Des produits rigoureusement sélectionnés, sourcés localement pour garantir fraîcheur et qualité </p></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" data-v-0641c9ec><!--[-->`);
      ...
      if (unref(featuredProducts).length > 0) {
        _push(`<section class="py-20 bg-[var(--color-bg)]" data-v-0641c9ec><div class="container-main" data-v-0641c9ec><div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14" data-v-0641c9ec><div data-v-0641c9ec><span class="label mb-3 block" data-v-0641c9ec>Les plus demandés</span><h2 class="heading-section" data-v-0641c9ec>Nos <span class="text-gradient" data-v-0641c9ec>best-sellers</span></h2></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/catalogue",
      ...
      _push(`<section class="py-24 bg-[var(--color-bg-warm)] relative overflow-hidden" data-v-0641c9ec><div class="orb orb-amber w-80 h-80 -top-20 -right-20 opacity-10" data-v-0641c9ec></div><div class="container-main relative" data-v-0641c9ec><div class="text-center mb-16" data-v-0641c9ec><span class="label mb-3 block" data-v-0641c9ec>Simple et rapide</span><h2 class="heading-section" data-v-0641c9ec>Comment ça <span class="text-gradient" data-v-0641c9ec>marche</span></h2><p class="text-[var(--color-text-muted)] mt-3 max-w-lg mx-auto" data-v-0641c9ec> Un processus en 4 étapes pensé pour votre tranquillité d&#39;esprit </p></div><div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative" data-v-0641c9ec><div class="hidden md:block absolute top-14 left-[12.5%] right-[12.5%] h-px" data-v-0641c9ec><div class="w-full h-full bg-gradient-to-r from-[var(--color-accent)]/20 via-[var(--color-accent)]/40 to-[var(--color-accent)]/20" data-v-0641c9ec></div></div><!--[-->`);
      ...
      if (testimonials.length > 0) {
        _push(`<section class="py-24 bg-[var(--color-bg)]" data-v-0641c9ec><div class="container-main" data-v-0641c9ec><div class="text-center mb-14" data-v-0641c9ec><span class="label mb-3 block" data-v-0641c9ec>Ils nous font confiance</span><h2 class="heading-section" data-v-0641c9ec>La parole à notre <span class="text-gradient" data-v-0641c9ec>communauté</span></h2></div><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-0641c9ec><!--[-->`);
      ...
      }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-0641c9ec> Faites la différence <span class="text-gradient-gold" data-v-0641c9ec>aujourd&#39;hui</span></h2><p class="text-xl text-white/70 mb-12 max-w-2xl mx-auto" data-v-0641c9ec> Des milliers de familles reçoivent déjà leurs colis grâce à TchadBox. Rejoignez-les et offrez le sourire à vos proches. </p><div class="flex flex-col sm:flex-row gap-4 justify-center" data-v-0641c9ec>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/catalogue",
        class: "btn-gold text-lg"
      }, {
...
//# sourceMappingURL=index-DSsfpU04.js.map
