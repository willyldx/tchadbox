import { c as useSeoMeta, i as useAuthStore, n as navigateTo, d as __nuxt_component_0, e as _export_sfc } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="card-glass rounded-2xl shadow-xl p-8" data-v-6772ab67><div class="text-center mb-8" data-v-6772ab67><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2" data-v-6772ab67>Créer un compte</h1><p class="text-[var(--color-text-muted)]" data-v-6772ab67>Rejoignez TchadBox et envoyez vos colis</p></div>`);
      if (unref(showSuccess)) {
        _push(`<div class="mb-6 p-4 bg-green-50 border border-green-100 rounded-xl" data-v-6772ab67><div class="flex items-start gap-3" data-v-6772ab67><svg class="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-6772ab67><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" data-v-6772ab67></path></svg><div data-v-6772ab67><p class="text-sm font-medium text-green-800" data-v-6772ab67>Compte créé avec succès !</p><p class="text-sm text-green-600 mt-1" data-v-6772ab67>Vérifiez votre email pour confirmer votre compte.</p></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<span data-v-6772ab67>${ssrInterpolate(unref(authStore).isLoading ? "Création..." : "Créer mon compte")}</span></button></form><p class="text-center text-[var(--color-text-secondary)] mt-8" data-v-6772ab67> Déjà un compte ? `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/auth/login",
      ...
      _push(`</p></div><div class="flex items-center justify-center gap-6 mt-8" data-v-6772ab67><div class="flex items-center gap-2 text-xs text-white/80 font-medium" data-v-6772ab67><svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-6772ab67><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" data-v-6772ab67></path></svg><span data-v-6772ab67>SSL sécurisé</span></div><div class="flex items-center gap-2 text-xs text-white/80 font-medium" data-v-6772ab67><svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-6772ab67><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" data-v-6772ab67></path></svg><span data-v-6772ab67>Données protégées</span></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=register-DNUBcCJD.js.map
