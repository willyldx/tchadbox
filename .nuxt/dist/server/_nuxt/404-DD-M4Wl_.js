import { c as useSeoMeta, d as __nuxt_component_0, e as _export_sfc } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><h2 class="text-2xl font-bold text-[var(--color-text)] mb-3" data-v-f32f1c37>Page introuvable</h2><p class="text-[var(--color-text-muted)] mb-8" data-v-f32f1c37> Oups ! Cette page semble s&#39;être perdue en route vers N&#39;Djamena. Elle n&#39;existe pas ou a été déplacée. </p><div class="flex flex-col sm:flex-row gap-4 justify-center" data-v-f32f1c37>`);
...
//# sourceMappingURL=404-DD-M4Wl_.js.map
