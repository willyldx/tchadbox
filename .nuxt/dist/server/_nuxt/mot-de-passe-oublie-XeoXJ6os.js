import { c as useSeoMeta, i as useAuthStore, d as __nuxt_component_0, e as _export_sfc } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(emailSent)) {
        _push(`<div class="text-center" data-v-d0b3b350><div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6" data-v-d0b3b350><svg class="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d0b3b350><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" data-v-d0b3b350></path></svg></div><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2" data-v-d0b3b350>Email envoyé !</h1><p class="text-[var(--color-text-muted)] mb-6" data-v-d0b3b350> Si un compte existe avec l&#39;adresse <strong data-v-d0b3b350>${ssrInterpolate(unref(form).email)}</strong>, vous recevrez un lien de réinitialisation. </p><p class="text-sm text-[var(--color-text-muted)] mb-8" data-v-d0b3b350> N&#39;oubliez pas de vérifier vos spams si vous ne voyez pas l&#39;email. </p><div class="space-y-3" data-v-d0b3b350><button class="w-full py-3 btn-outline" data-v-d0b3b350> Essayer une autre adresse </button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/auth/login",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d0b3b350${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-d0b3b350${_scopeId}></path></svg> Retour à la connexion `);
            } else {
              return [
...
//# sourceMappingURL=mot-de-passe-oublie-XeoXJ6os.js.map
