import { c as useSeoMeta, i as useAuthStore, k as useRoute, n as navigateTo, d as __nuxt_component_0, e as _export_sfc } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="card-glass rounded-[2rem] shadow-2xl p-8 sm:p-10" data-v-cb070de4><div class="text-center mb-8" data-v-cb070de4><h1 class="text-2xl font-bold text-[var(--color-text)] mb-2" data-v-cb070de4>Bon retour !</h1><p class="text-[var(--color-text-muted)]" data-v-cb070de4>Connectez-vous à votre compte TchadBox</p></div>`);
...
//# sourceMappingURL=login-B8YMZM2L.js.map
