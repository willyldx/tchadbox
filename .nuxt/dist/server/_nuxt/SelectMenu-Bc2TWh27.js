import { e as _export_sfc, l as __nuxt_component_0, v as __nuxt_component_1, o as useUI, p as useInjectButtonGroup, t as twMerge, q as appConfig, x as useDebounceFn, y as computedAsync, z as get, r as mergeConfig, A as select, B as selectMenu } from "../server.mjs";
import { defineComponent, computed, ref, inject, watchEffect, nextTick, watch, provide, h, Fragment, toRaw, reactive, cloneVNode, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, renderList, createTextVNode, Transition, toRef, useId, useSSRContext } from "vue";
import { useVirtualizer } from "@tanstack/vue-virtual";
import { d, e } from "./form-DsUILy5F.js";
import { o, t as t$2 } from "./active-element-history-QtuHblWR.js";
import { i as i$1, g as i$2, o as o$1, A as A$1, T, l, a as i$3, u as u$1, w, t as t$1, E, O, N, c as o$2, n, b as w$1, h as h$1, s as s$1 } from "./keyboard-BvysMIIh.js";
import { u, i as i$4, s, c, f as f$1, p, a as usePopper } from "./usePopper-CIeS2-3g.js";
import { f, u as u$2 } from "./hidden-CZ0WYEIB.js";
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  ...
  function D(p2) {
    p2.preventDefault(), p2.button === g.Left && (c$1.value || (o2.selectOption(u$12), n() || requestAnimationFrame(() => {
      var R;
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2 }) {
  ...
  let D = computed(() => o2.multiple ? 1 : 0), [y, L] = d(computed(() => o2.modelValue), (t2) => w$2("update:modelValue", t2), computed(() => o2.defaultValue)), M = computed(() => y.value === void 0 ? u$1(D.value, { [1]: [], [0]: void 0 }) : y.value), k = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
  ...
  }, computed(() => n2.value === 0)), provide($, k), t$1(computed(() => u$1(n2.value, { [0]: i$3.Open, [1]: i$3.Closed })));
  computed(() => {
    var t2;
  ...
  return () => {
    ...
    return h(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h(f, E({ features: u$2.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
...
//# sourceMappingURL=SelectMenu-Bc2TWh27.js.map
