import { i as useAuthStore, a as useHead, _ as __nuxt_component_3, d as __nuxt_component_0, b as __nuxt_component_3$1 } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="mb-8"><h1 class="text-2xl font-bold text-gray-900">Dashboard</h1><p class="text-gray-500 mt-1">Bienvenue, ${ssrInterpolate(unref(authStore).fullName)} 👋</p></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8"><!--[-->`);
...
//# sourceMappingURL=index-Dl9IWvuA.js.map
