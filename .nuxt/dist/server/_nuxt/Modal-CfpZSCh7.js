import { watchEffect, ref, defineComponent, computed, h, Fragment, watch, shallowRef, provide, inject, getCurrentInstance, Teleport, reactive, nextTick, normalizeClass, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, openBlock, createBlock, createCommentVNode, toRef, useId, useSSRContext } from "vue";
import { e as c$1, f as w$1, g as i$1, A as A$2, o, S, u as u$3, P, d as N$3, j as t$3, i as i$2, l as l$1, a as i$3, w as w$2, c as o$2, N as N$4, k as s$2, m as S$1, t as t$4, T as T$1, s as s$3 } from "./keyboard-BvysMIIh.js";
import { f as f$1, u as u$2 } from "./hidden-CZ0WYEIB.js";
import { t as t$1, a as t$2, o as o$1 } from "./active-element-history-QtuHblWR.js";
import { k } from "./description-DXB91rC2.js";
import { e as _export_sfc, o as useUI, r as mergeConfig, q as appConfig } from "../server.mjs";
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s2.value ? P(o(o$12), u$3(f2.value, { [d$2.Forwards]: () => N$3.Next, [d$2.Backwards]: () => N$3.Previous }) | N$3.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
    let u2 = {}, T2 = { ref: o$12, onKeydown: F, onFocusout: H2 }, { features: d2, initialFocus: w2, containers: Q2, ...O } = t2;
    return h(Fragment, [Boolean(d2 & 4) && h(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$2.Focusable }), A$2({ ourProps: T2, theirProps: { ...n$1, ...O }, slot: u2, attrs: n$1, slots: r, name: "FocusTrap" }), Boolean(d2 & 4) && h(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$2.Focusable })]);
  };
} }), { features: A$1 });
function W$1(t2) {
...
function N$1({ defaultContainers: o$12 = [], portals: i2, mainTreeNodeRef: H2 } = {}) {
  ...
  function u2() {
    ...
    for (let e2 of (l2 = r == null ? void 0 : r.querySelectorAll("html > *, body > *")) != null ? l2 : []) e2 !== (void 0).body && e2 !== (void 0).head && e2 instanceof HTMLElement && e2.id !== "headlessui-portal-root" && (e2.contains(o(t2)) || e2.contains((a2 = (f2 = o(t2)) == null ? void 0 : f2.getRootNode()) == null ? void 0 : a2.host) || n2.some((M2) => e2.contains(M2)) || n2.push(e2));
    return n2;
  }
  return { resolveContainers: u2, contains(n2) {
    return u2().some((l2) => l2.contains(n2));
  }, mainTreeNodeRef: t2, MainTreeNode() {
    return H2 != null ? null : h(f$1, { features: u$2.Hidden, ref: t2 });
  } };
}
...
let A = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p, expose: s$12 }) {
  ...
  })] }), ee = computed(() => w2.value ? "parent" : "leaf"), U2 = computed(() => S2 !== null ? (S2.value & i$3.Closing) === i$3.Closing : false), te = computed(() => N2 || U2.value ? false : k$1.value), le = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$2.value) == null ? void 0 : e2.querySelectorAll("body > *")) != null ? a2 : []).find((f2) => f2.id === "headlessui-portal-root" ? false : f2.contains(o(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  E(le, te);
  let ae = computed(() => w2.value ? true : k$1.value), oe = computed(() => {
    var e2, a2, d2;
    return (d2 = Array.from((a2 = (e2 = E$2.value) == null ? void 0 : e2.querySelectorAll("[data-headlessui-portal]")) != null ? a2 : []).find((f2) => f2.contains(o(K)) && f2 instanceof HTMLElement)) != null ? d2 : null;
  });
  ...
  return d$1(E$2, ue$1, (e2) => {
    ...
    return h(u$1, { force: true }, () => [h($, () => h(z, { target: m2.value }, () => h(u$1, { force: false }, () => h(ue, { initialFocus: a2, containers: B2, features: k$1.value ? u$3(ee.value, { parent: ue.features.RestoreFocus, leaf: ue.features.All & ~ue.features.FocusLock }) : ue.features.None }, () => h(X, {}, () => A$2({ ourProps: f2, theirProps: { ...d2, ...l2 }, slot: L2, attrs: l2, slots: p, visible: c2.value === 0, features: N$4.RenderStrategy | N$4.Static, name: "Dialog" })))))), h(Z)]);
  };
} });
...
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: null } }, inheritAttrs: false, setup(t2, { attrs: i2, slots: l2, expose: p }) {
  ...
  return p({ el: u2, $el: u2 }), () => {
    ...
    return h(u$1, { force: true }, () => h($, () => A$2({ ourProps: D, theirProps: { ...i2, ...g2 }, slot: { open: n2.dialogState.value === 0 }, attrs: i2, slots: l2, name: "DialogBackdrop" })));
  };
} });
...
let W = N$4.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s2, expose: h$1 }) {
  ...
  g(e2.leaveFrom);
  g(e2.leaveTo);
  return provide(N, P2), t$4(computed(() => u$3(i2.value, { ["visible"]: i$3.Open, ["hidden"]: i$3.Closed }) | n2.value)), () => {
  ...
  let h$1 = l$1(), n2 = computed(() => e2.show === null && h$1 !== null ? (h$1.value & i$3.Open) === i$3.Open : e2.show);
  watchEffect(() => {
...
//# sourceMappingURL=Modal-CfpZSCh7.js.map
