import { i as useAuthStore, a as useHead, _ as __nuxt_component_3, l as __nuxt_component_0 } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-4 py-6" }, _attrs))}><div class="mb-6"><h1 class="text-2xl font-bold text-gray-900">Historique</h1><p class="text-gray-500 mt-1">Toutes vos livraisons passées</p></div><div class="grid grid-cols-2 gap-3 mb-6"><div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100"><p class="text-3xl font-bold text-gray-900">${ssrInterpolate(unref(totalDeliveries))}</p><p class="text-sm text-gray-500">Livraisons totales</p></div><div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100"><div class="flex items-center gap-1">`);
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(filteredHistory), (delivery) => {
          ...
          _push(`<span>${ssrInterpolate(delivery.shippingAddress?.city || "N/A")}</span></div>`);
        ...
        _push(`</div><p class="text-gray-500 font-medium">Aucune livraison</p><p class="text-sm text-gray-400 mt-1">Votre historique apparaîtra ici</p></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=historique-JpWLsu-P.js.map
