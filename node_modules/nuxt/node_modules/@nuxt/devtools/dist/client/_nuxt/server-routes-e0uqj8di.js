import{C as e,Ct as t,E as n,F as r,Mt as i,P as a,Q as o,Qt as s,W as c,X as l,Y as u,_ as d,bt as f,c as p,ct as m,dt as h,en as g,ft as _,g as v,gt as y,h as b,l as x,lt as S,m as C,mt as w,t as ee,tn as T,v as E,w as D,xt as O}from"./vendor/json-editor-vue-hkofgjf7.js";import"./ready-szdlhgcr.js";import{h as k}from"./dist-mnod32r1.js";import"./nuxt-bfozs29x.js";import"./head-c2jgvqd9.js";import{B as A,S as j,c as te,f as M}from"./state-dkywakbf.js";import{U as ne,g as N,k as P,r as re,t as ie}from"./client-s5g5n0ac.js";import"./vendor/shiki-niqic03h.js";import{t as F}from"./storage-options-owy2vf04.js";import"./dev-auth-j4vxv6a1.js";import"./nuxt-link-mev16ngd.js";import{t as ae}from"./nicon-m5br9nvg.js";import{t as oe}from"./nbutton-oi1rfqiz.js";import{t as I}from"./ncard-ech06vlh.js";import{t as L}from"./state-routes-m6gv5n9v.js";import{t as se}from"./telemetry-bagjjni2.js";import{t as ce}from"./npanel-grids-bl37sfq7.js";import{t as le}from"./ntext-input-ngomk0u2.js";import{c as ue,d as de,h as fe,s as pe,u as me}from"#entry";import{t as he}from"./nselect-kgjpj17v.js";import"./client-lh91kcpv.js";import{t as ge}from"./ncode-block-coc4sua0.js";import{t as _e}from"./ndrawer-ijwn9421.js";import{t as R}from"./composables-cwesk2q8.js";import"./ncheckbox-k9nxqa1w.js";import{t as z}from"./nnavbar-n3j7iul1.js";import"./nicon-title-e35pdr21.js";import{t as B}from"./nsection-block-l0c6dpg8.js";import{t as ve}from"./code-snippets-ho13b87l.js";import{n as ye,t as be}from"./constants-lof1c7kz.js";import{t as xe}from"./nbadge-hpznun17.js";import{t as Se}from"./data-schema-button-ke4komn6.js";import{t as Ce}from"./server-route-inputs-lqwnul2k.js";var V=n({__name:`ServerRouteListItem`,props:{item:{},index:{default:0}},setup(n){let r=t(!0),a=L();return(t,o)=>{let f=ae,m=xe,h=H;return c(),E(`div`,null,[b(`button`,{flex:`~ gap-2`,"w-full":``,"items-start":``,"items-center":``,px2:``,py1:``,"hover-bg-active":``,class:s([{"bg-active":i(a)===n.item.filepath}]),style:g({paddingLeft:`calc(0.5rem + ${n.index*1.5}em)`}),onClick:o[0]||=e=>{r.value=!r.value,a.value=n.item.filepath}},[b(`div`,{class:s({"w-12":!n.item.routes}),"flex-none":``,"text-left":``},[n.item.type===`collection`?(c(),v(f,{key:0,icon:`carbon:chevron-right`,"mb0.5":``,"transform-rotate":r.value?90:0,transition:``},null,8,[`transform-rotate`])):(c(),v(m,{key:1,class:s(i(j)(n.item.method||`*`)),textContent:T((n.item.method||`*`).toUpperCase())},null,8,[`class`,`textContent`]))],2),b(`span`,{class:s({"flex items-center":n.item.routes}),"text-sm":``,"font-mono":``},[n.item.type===`collection`?(c(),v(f,{key:0,title:`${n.item.routes?.length} routes`,icon:`carbon:folder`,mr1:``},null,8,[`title`])):d(``,!0),e(` `+T(n.item.route),1)],2)],6),o[1]||=b(`div`,{"x-divider":``},null,-1),r.value?l(t.$slots,`default`,{key:0},()=>[(c(!0),E(p,null,u(n.item.routes,e=>(c(),v(h,{key:e.filepath,item:e,index:n.index+1},null,8,[`item`,`index`]))),128))]):d(``,!0)])}}}),H=Object.assign(V,{__name:`ServerRouteListItem`});function U(e,t){if(typeof e!=`string`)throw TypeError(`argument str must be a string`);let n={},r=t||{},i=r.decode||we,a=0;for(;a<e.length;){let t=e.indexOf(`=`,a);if(t===-1)break;let o=e.indexOf(`;`,a);if(o===-1)o=e.length;else if(o<t){a=e.lastIndexOf(`;`,t-1)+1;continue}let s=e.slice(a,t).trim();if(r?.filter&&!r?.filter(s)){a=o+1;continue}if(n[s]===void 0){let r=e.slice(t+1,o).trim();r.codePointAt(0)===34&&(r=r.slice(1,-1)),n[s]=W(r,i)}a=o+1}return n}function we(e){return e.includes(`%`)?decodeURIComponent(e):e}function W(e,t){try{return t(e)}catch{return e}}var G=/^[\u0009\u0020-\u007E\u0080-\u00FF]+$/;function Te(e,t,n){let r=n||{},i=r.encode||encodeURIComponent;if(typeof i!=`function`)throw TypeError(`option encode is invalid`);if(!G.test(e))throw TypeError(`argument name is invalid`);let a=i(t);if(a&&!G.test(a))throw TypeError(`argument val is invalid`);let o=e+`=`+a;if(r.maxAge!==void 0&&r.maxAge!==null){let e=r.maxAge-0;if(Number.isNaN(e)||!Number.isFinite(e))throw TypeError(`option maxAge is invalid`);o+=`; Max-Age=`+Math.floor(e)}if(r.domain){if(!G.test(r.domain))throw TypeError(`option domain is invalid`);o+=`; Domain=`+r.domain}if(r.path){if(!G.test(r.path))throw TypeError(`option path is invalid`);o+=`; Path=`+r.path}if(r.expires){if(!Ee(r.expires)||Number.isNaN(r.expires.valueOf()))throw TypeError(`option expires is invalid`);o+=`; Expires=`+r.expires.toUTCString()}if(r.httpOnly&&(o+=`; HttpOnly`),r.secure&&(o+=`; Secure`),r.priority)switch(typeof r.priority==`string`?r.priority.toLowerCase():r.priority){case`low`:o+=`; Priority=Low`;break;case`medium`:o+=`; Priority=Medium`;break;case`high`:o+=`; Priority=High`;break;default:throw TypeError(`option priority is invalid`)}if(r.sameSite)switch(typeof r.sameSite==`string`?r.sameSite.toLowerCase():r.sameSite){case!0:o+=`; SameSite=Strict`;break;case`lax`:o+=`; SameSite=Lax`;break;case`strict`:o+=`; SameSite=Strict`;break;case`none`:o+=`; SameSite=None`;break;default:throw TypeError(`option sameSite is invalid`)}return r.partitioned&&(o+=`; Partitioned`),o}function Ee(e){return Object.prototype.toString.call(e)===`[object Date]`||e instanceof Date}function K(e){if(typeof e!=`object`)return e;var t,n,r=Object.prototype.toString.call(e);if(r===`[object Object]`){if(e.constructor!==Object&&typeof e.constructor==`function`)for(t in n=new e.constructor,e)e.hasOwnProperty(t)&&n[t]!==e[t]&&(n[t]=K(e[t]));else for(t in n={},e)t===`__proto__`?Object.defineProperty(n,t,{value:K(e[t]),configurable:!0,enumerable:!0,writable:!0}):n[t]=K(e[t]);return n}if(r===`[object Array]`){for(t=e.length,n=Array(t);t--;)n[t]=K(e[t]);return n}return r===`[object Set]`?(n=new Set,e.forEach(function(e){n.add(K(e))}),n):r===`[object Map]`?(n=new Map,e.forEach(function(e,t){n.set(K(t),K(e))}),n):r===`[object Date]`?new Date(+e):r===`[object RegExp]`?(n=new RegExp(e.source,e.flags),n.lastIndex=e.lastIndex,n):r===`[object DataView]`?new e.constructor(K(e.buffer)):r===`[object ArrayBuffer]`?e.slice(0):r.slice(-6)===`Array]`?new e.constructor(e):e}var De={path:`/`,watch:!0,decode:e=>{let t=decodeURIComponent(e),n=k(t);return typeof n==`number`&&(!Number.isFinite(n)||String(n)!==t)?t:n},encode:e=>encodeURIComponent(typeof e==`string`?e:JSON.stringify(e))},q=globalThis.cookieStore;function Oe(e,n){let i={...De,...n};i.filter??=t=>t===e;let a=J(i)||{},o;i.maxAge===void 0?i.expires&&(o=i.expires.getTime()-Date.now()):o=i.maxAge*1e3;let s=o!==void 0&&o<=0,c=s||a[e]===void 0||a[e]===null,l=K(s?void 0:a[e]??i.default?.()),u=o&&!s?je(l,o,i.watch&&i.watch!==`shallow`):t(l);{let t=null;try{!q&&typeof BroadcastChannel<`u`&&(t=new BroadcastChannel(`nuxt:cookies:${e}`))}catch{}let n=(n=!1)=>{!n&&(i.readonly||A(u.value,a[e]))||(Ae(e,u.value,i),a[e]=K(u.value),t?.postMessage({value:i.encode(u.value)}))},o=t=>{let n=t.refresh?J(i)?.[e]:i.decode(t.value);s=!0,u.value=n,a[e]=K(n),r(()=>{s=!1})},s=!1,l=!!y();if(l&&f(()=>{s=!0,n(),t?.close()}),q){let t=t=>{let n=t.changed.find(t=>t.name===e),r=t.deleted.find(t=>t.name===e);n&&o({value:n.value}),r&&o({value:null})};q.addEventListener(`change`,t),l&&f(()=>q.removeEventListener(`change`,t))}else t&&(t.onmessage=({data:e})=>o(e));i.watch&&m(u,()=>{s||n()},{deep:i.watch!==`shallow`}),c&&n(c)}return u}function J(e={}){return U(document.cookie,e)}function ke(e,t,n={}){return t==null?Te(e,t,{...n,maxAge:-1}):Te(e,t,n)}function Ae(e,t,n={}){document.cookie=ke(e,t,n)}var Y=2147483647;function je(e,n,r){let i,a,o=0,s=r?t(e):{value:e};return y()&&f(()=>{a?.(),clearTimeout(i)}),w((e,t)=>{r&&(a=m(s,t));function c(){o=0,clearTimeout(i);let e=n-o,r=e<Y?e:Y;i=setTimeout(()=>{if(o+=r,o<n)return c();s.value=void 0,t()},r)}return{get(){return e(),s.value},set(e){c(),s.value=e,t()}}})}var Me={"h-full":``,"w-full":``,flex:`~ col`},Ne={flex:`~ col gap-2`,"n-navbar-glass":``,"flex-none":``,p4:``},Pe={flex:`~ gap2 items-center`},Fe={relative:``,"w-full":``},Ie={absolute:``,"right-2":``,"top-1.5":``,flex:`~ gap-1`},Le={flex:`~ gap2 wrap`,"w-full":``,"items-center":``,px4:``,pb2:``,"text-center":``,"text-sm":``,border:`b base`},Re={class:`hidden md:block`},ze={key:0,border:`b base`,"items-center":``,px4:``,py2:``,grid:`~ cols-[max-content_1fr] gap-2`},Be={"text-right":``,"font-mono":``},Ve={key:1,border:`b base`,p4:``,flex:`~ col gap-4`,"font-mono":``},He={flex:`~ gap-4`},Ue={flex:`~ gap2`,"mb--2":``,"items-center":``,op50:``},We={key:2},Ge={key:3,border:`b base`,relative:``,"n-code-block":``},Ke={flex:`~ wrap`,"w-full":``},qe=[`onClick`],Je={border:`b base`,flex:`~ gap2`,"items-center":``,px4:``,py2:``},Ye={key:1,"text-xs":``,op50:``},Xe={key:0,"flex-auto":``,"overflow-auto":``},Ze={border:`~ base`,"h-full":``,"w-full":``,rounded:``},Qe=[`data`],$e={key:2,"flex-auto":``,"overflow-auto":``,p4:``},et={border:`~ base`,rounded:``},tt=[`src`],nt={key:1,controls:``,rounded:``},rt=[`src`],X=n({__name:`ServerRouteDetails`,props:{route:{}},emits:[`openDefaultInput`],setup(n,{emit:r}){let l=n,f=r,[m,g]=N(),y=ie(),x=te(),w=re(),k=O({contentType:`text/plain`,data:``,statusCode:200,error:void 0,fetchTime:0}),A=C(()=>k.contentType.includes(`application/json`)?`json`:k.contentType.includes(`text/html`)?`html`:k.contentType.includes(`text/css`)?`css`:k.contentType.includes(`text/javascript`)?`javascript`:k.contentType.includes(`image`)||k.contentType.includes(`video`)?`media`:k.contentType.includes(`text/xml`)||k.contentType.includes(`application/xml`)?`xml`:k.contentType.includes(`application/pdf`)?`pdf`:`text`),M=C(()=>{if(A.value===`json`)return JSON.stringify(k.data,null,2);if(A.value===`media`||A.value===`pdf`){let e=new Blob([k.data],{type:k.contentType});return URL.createObjectURL(e)}return k.data}),I=t(!1),L=t(!1),ue=de(),pe=/((?:\*\*)?:\w+)/g,_e=C(()=>l.route.route?.split(pe)),R=C(()=>_e.value?.filter(e=>e.startsWith(`:`)||e.startsWith(`**:`))||[]),z=t(l.route.method||`GET`),B=t({}),V=O({query:[{active:!0,key:``,value:``,type:`string`}],body:[{active:!0,key:``,value:``,type:`string`}],headers:[{active:!0,key:`Content-Type`,value:`application/json`,type:`string`}]}),H=t({}),{inputDefaults:U,sendFrom:we}=F(`serverRoutes`),W=C(()=>w?.value?.app?.$fetch?we.value:`devtools`),G=[`GET`,`POST`,`PUT`,`PATCH`,`DELETE`,`HEAD`],Te=[`PATCH`,`POST`,`PUT`,`DELETE`],Ee=C(()=>Te.includes(z.value.toUpperCase())),K=t(),De=[`input`,`json`],q=t(De[0]),J=C({get:()=>V[K.value],set:e=>{V[K.value]=e}}),ke=C(()=>({...Z(U.value.query),...Z(V.query)})),Ae=C(()=>({...Z(U.value.headers),...Z(V.headers)})),Y=C(()=>Ee.value?q.value===`json`?{...Z(U.value.body),...H.value}:{...Z(U.value.body),...Z(V.body)}:void 0),je=C(()=>{let e=window?.location.origin;return e.charAt(e.length-1)===`/`&&(e=e.slice(0,-1)),e}),X=C(()=>{let e=new URLSearchParams(ke.value).toString();e&&=`?${e}`;let t=(_e.value?.map(e=>(e.startsWith(`:`)||e.startsWith(`**:`))&&B.value[e]||e).join(``)||``)+e,n=x.value?.app.baseURL||``;return(n===`./`||n===`.`)&&(n=``),n.endsWith(`/`)&&(n=n.slice(0,-1)),n+t}),it=C(()=>je.value+X.value);function Z(e=[]){let t=Object.fromEntries(e.filter(({active:e,key:t,value:n})=>e&&t&&n!==void 0).map(({key:e,value:t})=>[e,t]));return Object.entries(t).length?t:void 0}async function at(){L.value=!0,I.value=!0;let e=Date.now(),t=W.value===`app`?w.value.app.$fetch:$fetch;se(`server-routes:fetch`,{method:z.value,sendFrom:W.value});try{k.data=await t(it.value,{method:z.value.toUpperCase(),headers:Ae.value,query:ke.value,body:Y.value,onResponse({response:e}){k.contentType=(e.headers.get(`content-type`)||``).toString().toLowerCase().trim(),k.statusCode=e.status,k.error=void 0},onResponseError(e){k.error=e.response._data,k.data=e.response._data}})}catch{}I.value=!1,k.fetchTime=Date.now()-e}let ot=C(()=>{let e=[],t=[],n=Object.entries(Ae.value).filter(([e,t])=>e&&t&&!(e===`Content-Type`&&t===`application/json`)).map(([e,t])=>`  '${e}': '${t}'`).join(`,
