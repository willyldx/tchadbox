import{C as e,E as t,W as n,_ as r,dt as i,g as a,h as o,m as s,tn as c,v as l,w as u}from"./vendor/json-editor-vue-hkofgjf7.js";import"./ready-szdlhgcr.js";import"./nuxt-bfozs29x.js";import"./head-c2jgvqd9.js";import"./state-dkywakbf.js";import{r as d}from"./client-s5g5n0ac.js";import"./vendor/shiki-niqic03h.js";import"./storage-options-owy2vf04.js";import"./dev-auth-j4vxv6a1.js";import"./nicon-m5br9nvg.js";import"./state-routes-m6gv5n9v.js";import"./telemetry-bagjjni2.js";import{p as f}from"#entry";import{t as p}from"./composables-cwesk2q8.js";import"./filepath-item-fnp9jxof.js";import{t as m}from"./stacktrace-list-m1sv2uvd.js";var h=/(^|@)\S+:\d+/,g=/^\s*at .*(\S+:\d+|\(native\))/m,_=/^(eval@)?(\[native code\])?$/;function v(e,t){if(e.stacktrace!==void 0||e[`opera#sourceloc`]!==void 0)return T(e,t);if(e.stack&&e.stack.match(g))return x(e,t);if(e.stack)return C(e,t);if(t?.allowEmpty)return[];throw Error(`Cannot parse given Error object`)}function y(e){if(!e.includes(`:`))return[e,void 0,void 0];let t=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,``));return[t[1],t[2]||void 0,t[3]||void 0]}function b(e,t){return t&&t.slice!=null?Array.isArray(t.slice)?e.slice(t.slice[0],t.slice[1]):e.slice(0,t.slice):e}function x(e,t){return S(e.stack,t)}function S(e,t){return b(e.split(`
...
`).filter(e=>!!e.match(h)&&!e.match(/^Error created at/)),t).map(e=>{let t=e.split(`@`),n=y(t.pop()),r=t.shift()||``,i=r.replace(/<anonymous function(: (\w+))?>/,`$2`).replace(/\([^)]*\)/g,``)||void 0,a;return r.match(/\(([^)]*)\)/)&&(a=r.replace(/^[^(]+\(([^)]*)\)$/,`$1`)),{function:i,args:a===void 0||a===`[arguments not available]`?void 0:a.split(`,`),file:n[0],line:n[1]?+n[1]:void 0,col:n[2]?+n[2]:void 0,raw:e}})}function k(e){return e.map(e=>({functionName:e.function,args:e.args,fileName:e.file,lineNumber:e.line,columnNumber:e.col,source:e.raw}))}function A(e,t){return k(v(e,t))}var j={p6:``},M={key:0},N={"text-6xl":``},P={key:0,op75:``},F={my4:``,"text-xl":``,"text-red":``},I={key:1,"of-auto":``,rounded:``,"bg-active":``,p2:``},L=[`textContent`],R={key:1,op50:``},z=t({__name:`error`,setup(t){p({icon:`i-carbon-warning-alt-filled text-red`,title:`Error`,category:`app`,show(){let e=d();return()=>e.value?.nuxt?.payload?.error}});let h=/<.*?>/g,g=d(),_=s(()=>{let e=g.value?.nuxt?.payload?.error;return e&&(console.error(`[Nuxt DevTools] Error in payload:`),console.error(e),console.error({...e})),e}),v=s(()=>{if(!_.value?.stack)return[];try{return _.value.stack.startsWith(`<pre>`)?A({stack:_.value.stack.replace(h,``)}):A(_.value)}catch(e){return console.error(e),[]}});return(t,s)=>{let d=f,p=m;return n(),l(`div`,j,[_.value?(n(),l(`div`,M,[u(d,{n:`red`,icon:`i-carbon-warning-alt-filled`,mb5:``},{default:i(()=>[...s[0]||=[e(` Error occurred in this page `,-1)]]),_:1}),o(`div`,N,c(_.value.statusCode||`Client Error`),1),_.value.statusMessage?(n(),l(`div`,P,c(_.value.statusMessage),1)):r(``,!0),o(`div`,F,c(_.value.message||_.value.description||`Unknown error`),1),v.value.length||_.value.stack?(n(),l(`div`,I,[s[1]||=o(`div`,{px1:``,op50:``},` Stacktrace `,-1),v.value.length?(n(),a(p,{key:0,px2:``,stacktrace:v.value},null,8,[`stacktrace`])):(n(),l(`pre`,{key:1,textContent:c(_.value.stack)},null,8,L))])):r(``,!0)])):(n(),l(`div`,R,` No error `))])}}});export{z as default};